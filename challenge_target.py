...
class ResNetBlock_target(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1):
        super(ResNetBlock_target, self).__init__()
...
class Challenge_target(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=2):
        ...
        """
        super(Challenge_target, self).__init__()
        self.in_channels = 64
...
def getResNet18_target():
    return Challenge_target(ResNetBlock_target, [2,2,2,2])